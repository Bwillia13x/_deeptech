...
const mockDiscoveriesData: Discovery[] = [
  ...
  },
  {
    ...
    type: "post",
    source: "facebook",
    sourceId: "meta_ai/2025-ai-milestone",
    title: "Meta AI releases multimodal code generation insights",
    text: "Meta AI shared new multimodal code synthesis benchmarks demonstrating 17% reduction in hallucinations across Python and Rust models.",
    url: "https://facebook.com/meta_ai/posts/2025-ai-milestone",
    publishedAt: "2025-02-05T14:00:00Z",
    authorEntityIds: "[15]",
    createdAt: "2025-02-05T14:05:00Z",
    novelty: 65.0,
    emergence: 48.2,
    obscurity: 42.1,
    discoveryScore: 58.9,
    computedAt: "2025-02-05T15:00:00Z",
  },
  {
    id: "8",
    type: "post",
    source: "linkedin",
    sourceId: "linkedin-labs/ai-safety",
    title: "LinkedIn Labs posts about AI safety framework",
    text: "LinkedIn Labs published a safety framework for workplace AI assistants, outlining monitoring, governance, and user control layers.",
    url: "https://linkedin.com/posts/linkedin-labs_ai-safety-framework",
    publishedAt: "2025-02-03T09:15:00Z",
    authorEntityIds: "[16]",
    ...
    obscurity: 38.6,
    discoveryScore: 53.2,
    computedAt: "2025-02-03T10:00:00Z",
  },
  {
    id: "9",
    type: "reddit_post",
    source: "reddit",
    sourceId: "reddit-ai/abcdef",
    title: "Reddit discusses few-shot synthesis breakthroughs",
    text: "Community thread in r/artificial highlights a new few-shot model that codes robotics policies using only eight prompts.",
    url: "https://reddit.com/r/artificial/comments/abcdef",
    publishedAt: "2025-02-01T21:45:00Z",
    authorEntityIds: "[17]",
    createdAt: "2025-02-01T22:00:00Z",
    novelty: 72.1,
    emergence: 64.0,
    obscurity: 47.8,
    discoveryScore: 66.4,
    computedAt: "2025-02-01T23:00:00Z",
  },
  {
    id: "10",
    type: "story",
    source: "hackernews",
    sourceId: "hn-54321",
    title: "Ask HN: How are labs shipping quantum compute apps?",
    text: "Ask HN thread where researchers share production stories about shipping quantum compute tooling and frequency issues.",
    url: "https://news.ycombinator.com/item?id=54321",
    publishedAt: "2025-01-30T12:30:00Z",
    authorEntityIds: "[18]",
    createdAt: "2025-01-30T12:35:00Z",
    novelty: 58.2,
    emergence: 50.9,
    obscurity: 36.7,
    discoveryScore: 52.3,
    computedAt: "2025-01-30T13:10:00Z",
  },
];
